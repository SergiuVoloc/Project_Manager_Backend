...
namespace Evidenta.Controllers
{
    public class StudentsController : Controller
    {
        ...
        public StudentsController(DefaultContext context)
        {
            _context = context;
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("StudentId,Password,Username,StudentName,Group,Field,Year")] Student student)
        {
