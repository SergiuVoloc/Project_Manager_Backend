...
namespace Evidenta.Controllers
{
    public class TeachersController : Controller
    {
        ...
        public TeachersController(DefaultContext context)
        {
            _context = context;
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("TeacherId,Password,Username,TeacherName,Subject")] Teacher teacher)
        {
